<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    {{ __('Dashboard Staff - Perpustakaan Azfakun') }}
                </h2>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- Welcome Banner -->
            <div class="bg-gradient-to-r from-green-600 via-teal-600 to-cyan-700 rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <a href="/ManajemenKategori" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Manajemen kategori buku</p>
                            </div>
                        </a>
