                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div class="mb-4 md:mb-0">
                            ...
                            <p class="text-sm text-gray-600">Kelola peminjaman buku perpustakaan</p>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-4">
                            <div class="relative">
                                <input type="text" placeholder="Cari peminjaman..." class="w-full sm:w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        @if(Auth::user() && in_array(Auth::user()->role, ['admin', 'staff']))
                                        <button class="extend-btn text-blue-600 hover:text-blue-900" data-loan-id="1">Perpanjang</button>
                                        <button class="return-btn text-green-600 hover:text-green-900" data-loan-id="1">Kembalikan</button>
                                        @endif
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        @if(Auth::user() && in_array(Auth::user()->role, ['admin', 'staff']))
                                        <button class="extend-btn text-blue-600 hover:text-blue-900" data-loan-id="2">Perpanjang</button>
                                        <button class="return-btn text-green-600 hover:text-green-900" data-loan-id="2">Kembalikan</button>
                                        @endif
                                        <button class="text-gray-600 hover:text-gray-900">Detail</button>
                                    </div>
                                </td>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        @if(Auth::user() && in_array(Auth::user()->role, ['admin', 'staff']))
                                        <button class="extend-btn text-blue-600 hover:text-blue-900" data-loan-id="3">Perpanjang</button>
                                        <button class="return-btn text-green-600 hover:text-green-900" data-loan-id="3">Kembalikan</button>
                                        @endif
                                        <button class="text-gray-600 hover:text-gray-900">Detail</button>
                                    </div>
                                </td>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        @if(Auth::user() && in_array(Auth::user()->role, ['admin', 'staff']))
                                        <button class="extend-btn text-blue-600 hover:text-blue-900" data-loan-id="4">Perpanjang</button>
                                        <button class="return-btn text-green-600 hover:text-green-900" data-loan-id="4">Kembalikan</button>
                                        @endif
                                        <button class="text-gray-600 hover:text-gray-900">Detail</button>
                                    </div>
                                </td>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Showing <span class="font-medium">1</span> to <span class="font-medium">4</span> of <span class="font-medium">89</span> results
                            </p>
                        </div>
                        <div>
