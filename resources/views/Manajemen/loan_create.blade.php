    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Tambahkan peminjaman buku baru</p>
            </div>
                    ...
                    <form action="{{ route('loans.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" placeholder="Catatan tambahan (opsional)...">{{ old('notes') }}</textarea>
